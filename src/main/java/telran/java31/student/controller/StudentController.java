...
public class StudentController {
	...
	@PostMapping("/student") // такой запрос переадресовывает на этот метод
	...
	public StudentDto editStudent(@PathVariable Integer id, @RequestBody StudentUpdateDto studentUpdateDto) {
...
//все эти методы принимают запросы из интернета
